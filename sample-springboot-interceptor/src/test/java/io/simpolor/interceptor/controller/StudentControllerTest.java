package io.simpolor.interceptor.controller;

import com.fasterxml.jackson.databind.ObjectMapper;
import io.simpolor.interceptor.config.WebMvcConfig;
import io.simpolor.interceptor.domain.Student;
import io.simpolor.interceptor.interceptor.EnrolledStudentInterceptor;
import io.simpolor.interceptor.service.StudentService;
...
@WebMvcTest(controllers = {EnrolledStudentInterceptor.class, WebMvcConfig.class, StudentController.class})
public class StudentControllerTest {
    ...
    public void testStudentModify()throws Exception {
        ...
        when(studentService.modifyStudent(any())).thenReturn(student);
