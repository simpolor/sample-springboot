package io.simpolor.interceptor.service;

import io.simpolor.interceptor.domain.Student;
import io.simpolor.interceptor.repository.StudentRepository;
...
public class StudentServiceTest {
    ...
    public void testGetStudentTotalCount(){
        ...
        // given
        when(studentRepository.selectStudentTotalCount()).thenReturn(3L);
    ...
    public void testGetStudentList(){
        ...
        when(studentRepository.selectStudentList()).thenReturn(students);
    ...
    public void testModifyStudent(){
        ...
        when(studentRepository.updateStudent(student)).thenReturn(seq);
    ...
    public void testDeleteStudent(){
        ...
        when(studentRepository.deleteStudent(seq)).thenReturn(seq);
